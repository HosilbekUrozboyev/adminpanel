                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <div style="color: red" id="password-help" class="form-text">Parol kamida 8 ta belgidan iborat bo'lsin</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputPhoneNumber" type="tel" pattern="" name="phoneNumber" required />
